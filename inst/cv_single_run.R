...
print(paste0("N: ",n_," SD: ", sd_, " nIknots: ", nIknots,
             ...
             "Update \tau_\beta: ", update_tau_beta, " Dif.Order:", dif_order, "\n"))
...
saveRDS(object = rsp_mod,file = paste0("/users/research/mmarques/spline_bart_lab/preliminar_results/rspBART17/",type_,"/single_run/v23_single_run_rep_",
                                       selected_rep_,"_n_",n_,
                                      "_sd_",sd_,"_ntau_b_",rsp_mod$prior$ntau_beta,"_nIknots_",nIknots,"_ntree_",n_tree,"_nodesize_",node_min_size,
                                      "_dif_",dif_order,"_scale_",scale_bool,"_sc_basis_",scale_basis_function,
                                      "_nmcmc_",n_mcmc,"_nburn_",n_burn,"_rb_prior_",robust_prior,"_eta_",rsp_mod$prior$eta,".Rds"))
